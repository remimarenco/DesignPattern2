...
public class MarsupialObservable extends Marsupial implements IObservable{
	...
	{
		//on met le marsu dans le comportement observable pour recupere le libell̩
	...
	{
		//on applle une fonction du comportement diff̩rente (dormir ou reveille) en fonction de l'etat du marsu
